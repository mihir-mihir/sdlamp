...
int main(int argc, char **argv)
{
    ...
    window = SDL_CreateWindow("Hello SDL", 40, 0, 640, 480, SDL_WINDOW_FULLSCREEN);
    if (!window) {
...
*/
    ...
    const SDL_Rect rewind_rect = { OL + 100, 100, 100, 100 };
    const SDL_Rect pause_rect = { OL+ 400, 100, 100, 100 };
